...
This circuit board should cover most MBC5 games, and is able to make games up to 2 MB in size, that use up to 256 Kbit of RAM. It is fully compatible with both the <a href="https://www.gbxcart.com/">GBxCart RW</a> and sanni's <a href="https://github.com/sanni/cartreader">Open Source Cart Reader (OSCR)</a> so you can transfer games and save files to and from the board. Because of the FRAM this board utilizes, it is technically only fully compatible with regular Game Boy games, and not Game Boy Color games, though no issues have been reported in the past when using them with Game Boy Color games.
